        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-xl p-6 md:p-8 border border-gray-200 dark:border-gray-700">
                ...
                <form action="{{ route('admin.projects.update', $project->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <!-- Judul Proyek -->
                    <div>
                        <label for="title" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Judul Proyek</label>
                    ...
                    <!-- Deskripsi Proyek -->
                    <div>
                        <label for="description" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Deskripsi Proyek</label>
                        <textarea name="description" id="description" rows="4" required
                            class="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 !text-gray-900 dark:!text-white focus:ring-2 focus:ring-indigo-500 font-medium">{{ old('description', $project->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="tech_stack" id="tech_stack" value="{{ old('tech_stack', is_array($project->tech_stack) ? implode(', ', $project->tech_stack) : $project->tech_stack) }}" required
                            class="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 !text-gray-900 dark:!text-white focus:ring-2 focus:ring-indigo-500 font-medium">
                    </div>
                    ...
                    @if($project->image)
                        <div>
                            ...
                            <div class="w-40 h-28 rounded-lg overflow-hidden border border-gray-300 dark:border-gray-700">
                    ...
                    <!-- Upload Gambar Baru -->
                    <div>
                        <label for="image" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Upload Gambar Baru <span class="text-xs font-normal text-gray-500">(Biarkan kosong jika tidak ingin mengubah)</span></label>
